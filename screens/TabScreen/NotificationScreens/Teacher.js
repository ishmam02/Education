...
const Teacher = ({fetchNotifications ,teacherNotifications}) => {
    ...
    return (
      ...
      >  
          <View >{teacherNotifications.map( notification => {
...
const mapStateToProps = (state) => {
    return { teacherNotifications: state.notifications.filter(school => school.type === 'Teacher')}
  };

export default connect(mapStateToProps, {fetchNotifications})(Teacher);