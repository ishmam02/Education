...
const School = ({fetchNotifications ,schoolNotifications}) => {
    ...
    return (
      ...
      >  
          <View >{schoolNotifications.map( notification => {
...
const mapStateToProps = (state) => {
    return { schoolNotifications: state.notifications.filter(school => school.type === 'School')}
  };

export default connect(mapStateToProps, {fetchNotifications})(School);